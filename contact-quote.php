...
<!-- Mirrored from html.rudhisasmito.com/walls/contact-quote.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Jul 2023 13:41:54 GMT -->
			...
			<div class="row">
				...
				<div class="col-sm-9 col-md-9">
					<div class="content">
						...
						<form action="#" class="form-contact" id="quoteForm" data-toggle="validator" novalidate="true">
							<div class="form-group">
								<input type="text" class="form-control" id="p_name" placeholder="Full Name..." required="">
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<select class="form-control" id="p_select">
