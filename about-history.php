...
<!-- Mirrored from html.rudhisasmito.com/walls/about-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Jul 2023 13:40:41 GMT -->
<head>
    <!-- Basic Page Needs
    ================================================== -->
    <meta charset="utf-8">
				...
				<div class="col-sm-12 col-md-12">
					...
					<div class="history-2">
		              <div class="timeline__item">
		                <div class="media"><img src="images/history-1.jpg" class="img-responsive" alt="Company History"></div>
		                <div class="aksen"></div>
		                <div class="text">
		              ...
		              <div class="timeline__item">
		                <div class="media"><img src="images/history-2.jpg" class="img-responsive" alt="Company History"></div>
		                <div class="aksen"></div>
		                <div class="text">
		              ...
		              <div class="timeline__item">
		                <div class="media"><img src="images/history-3.jpg" class="img-responsive" alt="Company History"></div>
		                <div class="aksen"></div>
		                <div class="text">
		              ...
		              <div class="timeline__item">
		                <div class="media"><img src="images/history-4.jpg" class="img-responsive" alt="Company History"></div>
		                <div class="aksen"></div>
		                <div class="text">
